...
if ( ! class_exists( 'Willow_Custom_Menu' ) ):

// Class dependencies
if ( ! class_exists( 'Willow_Nav_Walker' ) ):
	require_once 'willow_nav_walker.php';
endif;

class Willow_Custom_Menu {
	...
	function __construct() {
		...
		$this->fields = apply_filters( 'willow_nav_menu_item_custom_fields', $this->fields );
	...
	public function edit_nav_menu_walker() {
		...
		if ( ! class_exists( 'Willow_Edit_Nav_Walker' ) )
			require_once 'willow_edit_nav_walker.php';

		return 'Willow_Edit_Nav_Walker';
	}
 ...
 */
add_filter( 'willow_nav_menu_item_custom_fields', 'willow_custom_menu' );

function willow_custom_menu( $fields ) {
